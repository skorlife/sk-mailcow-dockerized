...
class __TwigTemplate_5e920501fd36c5683115c6a7d8b2cf93 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 1
        echo "<div role=\"tabpanel\" class=\"tab-pane fade show\" id=\"tab-templates-domains\" role=\"tabpanel\" aria-labelledby=\"tab-templates-domains\">
  <div class=\"card mb-4\">
    <div class=\"card-header d-flex fs-5\">
      <button class=\"btn d-sm-block d-md-none flex-grow-1 text-start\" data-bs-target=\"#collapse-tab-templates-domains\" data-bs-toggle=\"collapse\" aria-controls=\"collapse-tab-templates-domains\">
        ";
        // line 5
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["lang"] ?? null), "mailbox", [], "any", false, false, false, 5), "domain_templates", [], "any", false, false, false, 5), "html", null, true);
        echo " <span class=\"badge bg-info table-lines\"></span>
      </button>
      <span class=\"d-none d-md-block\">";
        // line 7
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["lang"] ?? null), "mailbox", [], "any", false, false, false, 7), "domain_templates", [], "any", false, false, false, 7), "html", null, true);
    ...
    <div id=\"collapse-tab-templates-domains\" class=\"card-body collapse show\" data-bs-parent=\"#mail-content\">  
      <div class=\"mass-actions-mailbox mb-4\">
        ...
        if ((($context["mailcow_cc_role"] ?? null) == "admin")) {
            // line 20
            echo "              <li><a class=\"dropdown-item\" data-action=\"delete_selected\" data-id=\"domain_template\" data-api-url='delete/domain/template' href=\"#\">";
        ...
        if ((($context["mailcow_cc_role"] ?? null) == "admin")) {
            // line 27
            echo "          <a class=\"btn btn-sm btn-success\" href=\"#\" data-bs-toggle=\"modal\" data-bs-target=\"#addDomainTemplateModal\"><i class=\"bi bi-plus-lg\"></i> ";
